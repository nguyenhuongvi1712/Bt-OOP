...
public class Aims_G extends JFrame{
    ...
    private JButton chooseOption5Button;
    ...
    public Aims_G() {
      setSize(500,500);
        chooseOption1Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, limitExceededException.getMessage(),"Warning",JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        chooseOption4Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(Aims_gui.case1==0)
                    ...
                    frame2 = new MediaList_GUI(anOrder);
                    frame2.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                    frame2.pack();
                    frame2.setVisible(true);
        ...
        chooseOption5Button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if(Aims_gui.case1==0)
                    JOptionPane.showMessageDialog(null,"The Media list is empty !");
                else{
                    frame2 = new JFrame("Get Lucky Item");
                    frame2 = new getLuckyItem_GUI(anOrder);
                    frame2.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                    frame2.pack();
                    frame2.setVisible(true);
